const TagFunctionMap={
    "food":function(ItemID,UUID=void 0){
        ...
        if(TGET("now_selecting_action")==="Survive"){
            return ComponentRender(LoadedComponentList["_component_ability_button"],$$l._tag_function_food+` ${ItemList[ItemID].name}`,cost,()=>{
    ...
    "tinned":function(ItemID,UUID=void 0){
        ...
        if(TGET("now_selecting_action")==="Survive"){
            return ComponentRender(LoadedComponentList["_component_ability_button"],$$l._tag_function_tinned+` ${ItemList[ItemID].name}`,cost,()=>{
...
const TagFunction=new Proxy(TagFunctionMap,{
    get:(item,property)=>{
        return function(){
            ...
            if(typeof arguments[0] !== "string") throw new Error("Tag Function:Not An Item ID.");
            if(!GET("backpack_items")[arguments[0]]) throw new Error("Tag Function:Player Dont Have The Item "+arguments[0]);
