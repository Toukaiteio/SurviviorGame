...
Render=function(){
    if(!TGET("music_info_animation_style")){
        ...
        TSTORE("music_info_animation_style",ApplyStyle("@keyframes popup",`
            from{
        ...
        `))
        TSTORE("music_info_animation_style",ApplyStyle("@keyframes fadeout",`
            from{
                opacity:1;
            }
            to{
        ...
        `))
        ApplyStyle("div#_component_music_info div#_music_name",`
            transform:translateX(100%);
            animation-delay:0.6s;
            animation:popup 1.2s forwards;
        `)
        ApplyStyle("div#_component_music_info div#_music_author",`
            transform:translateX(100%);
            animation-delay:0.9s;
            animation:popup 1.2s forwards;
        `)
        ApplyStyle("div#_component_music_info div#_music_album",`
            transform:translateX(100%);
            animation-delay:1.2s;
            animation:popup 1.2s forwards;
        `)
        ApplyStyle("div#_component_music_info.fadeout",`
