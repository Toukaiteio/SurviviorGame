...
(async () => {
  ...
  try {
    ...
    await Load_Script("./Scripts/Functions/GameEventInterceptorGenerator.js");
    await Load_Script("./Scripts/Functions/GameMapGenerator.js");
    await Load_Script("./Scripts/Functions/GameAbilityGenerator.js");
    await Load_Script("./Scripts/Functions/GameActionGenerator.js");
    await Load_Script("./Scripts/Functions/GameNpcConfig.js");
    await Load_Script("./Scripts/Controller/ObjectController.js");
